...
from CDUTRestful.app.WeCDUT.CDUTSpider.helper.BookBrief import BookBrief


class BookSearchSpider:
    def __init__(self, book_name):
        url_format = r'http://www.lib.cdut.edu.cn/opac/search?tag=search&subtag=simsearch' \
        ...
        url = url_format.format(book_name)
        self.url = url
        ...
        try:
            ...
            for item in search_array:
                ...
                if item.select_one('.subject'):
                    ...
                    class_info = ''
                book_brif = BookBrief(book_detail_url, book_name, book_creator, index_num, isbn, public_info, class_info)
